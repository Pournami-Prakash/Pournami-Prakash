...
CODE = [
    ...
    [],
    [("    def ", C_KEY), ("links", C_FUNC), ("(", C_PLAIN), ("self", C_VAR),
     ("):", C_PLAIN)],
    [("        return ", C_KEY), ("{", C_PLAIN),
     ('"portfolio"', C_STR), (": ", C_PLAIN),
     ('"pournamiprakash.dev"', C_STR), (",", C_PLAIN)],
    [("                ", C_PLAIN),
     ('"linkedin"', C_STR), (":  ", C_PLAIN),
     ('"in/pournami-prakash"', C_STR), ("}", C_PLAIN)],
    [],
    [("# a few certifications in progress", C_COMMENT)],
]
